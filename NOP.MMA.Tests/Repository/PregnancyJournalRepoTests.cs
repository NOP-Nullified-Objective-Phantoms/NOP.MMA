...
namespace NOP.MMA.Repository
{
    public class PregnancyJournalRepoTests
    {
        ...
        public void CanGetByID ()
        {
            ...
            bool notNull;
            bool correctID;
            JournalHelper.ManualStorageInsertion (journal, PregnancyJournalRepo.Link.StoragePath);  //  Ensuring that an entry exists in storage
        ...
        public void CanUpdatePregnancyJournal ()
        {
            ...
            JournalHelper.ManualStorageInsertion (journal, PregnancyJournalRepo.Link.StoragePath);
        ...
        public void CanGetEnumerator ()
        {
            ...
            bool notEmpty;
            bool correctAmount;
            JournalHelper.ManualStorageInsertion (JournalFactory.Create (JournalType.PregnancyJournal), PregnancyJournalRepo.Link.StoragePath);
            JournalHelper.ManualStorageInsertion (JournalFactory.Create (JournalType.PregnancyJournal), PregnancyJournalRepo.Link.StoragePath, true);
            JournalHelper.ManualStorageInsertion (JournalFactory.Create (JournalType.PregnancyJournal), PregnancyJournalRepo.Link.StoragePath, true);
